...
<body>
    ...
    <img  class="banner" src="./img/menu/banner.svg" alt=" uma mulher apontando para o menu de navegação de um site">
    <main class="position-relative">
        ...
        <article class="ms-auto col-12 col-md-8 container">
            ...
            <img src="./img/menu/im3.svg" alt="Três botões alinhados horizontalmente, onde todos estão com a fonte na cor amarela e o fundo azul. O primeiro contém o texto Início, o segundo Notícias e o terceiro Blog com pouco espaço entre si e com uma área de clique muito pequena.">
            ...
            <img src="./img/menu/im4.svg" alt="Três botões alinhados horizontalmente, onde todos estão com a fonte na cor amarela e o fundo azul. O primeiro contém o texto Início, o segundo Notícias e o terceiro Blog com um bom espaço entre os elementos e uma área de clique maior.">
