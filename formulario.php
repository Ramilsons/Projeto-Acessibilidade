...
<head>
    ...
    <link rel="stylesheet" href="./css/paginas/form.css">
...
<body>
    ...
    <main> 
        <img src="img/form/banner_form.png" alt=" um formulário sendo checado com a ajuda de um lápis">
                    ...
                    <section class="container">
                        <div class="row">  
                            <div class="col-sm-12 ">
                                ...
                                <b><p class="pt-3">Os elementos FIELDSET e LEGEND</p></b>
                        ...
                        <h4 class="pt-3"> O elemento OPTGROUP </h4>
                        ...
                        <h4 class="pt-3">Menu Javascript (menus drop-down)</h4>
                        ...
                        <h5 class="pt-3">Mensagens de erros no lado do SERVIDOR</h5>
